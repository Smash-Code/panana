...
const Work = () => {
    return (
        <div className=' mx-auto max-w-[1350px] mt-[0px] md:mt-[180px] pt-[90px] md:pt-[180px] px-[10px]  md:px-[50px] lg:px-[165px]' >
                ...
                <div className='col-span-12 md:col-span-6 space-y-[24px]' >
                    ...
                    <div data-aos="fade-left" className=' grid grid-cols-12 rounded-[8px] p-[24px] border-2 border-[#FFDF88] bg-[#FFF7D5]' >
                        <div className='h-full flex flex-col justify-between col-span-12 md:col-span-7' >
                            ...
                            <div className='mt-[16px] text-[22px] md:text-[31px] md:leading-[32px] font-bold ' >
                                Get Unfiltered,
                                Accurate Forecasts
                            </div>
                        ...
                        <div className='col-span-12 md:col-span-4' >
                            <Image src='/assets/images/work2.svg' width={680} height={981} alt='Work2' />
                        </div>
