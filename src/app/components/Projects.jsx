...
const Projects = () => {
    return (
        <div className="text-center flex flex-col items-center mx-auto lg:pt-[88px] px-[10px] md:px-[50px] lg:px-[165px]" >
            ...
            <div className="flex flex-wrap justify-center gap-x-[30px] gap-y-[40px] items-center w-full mt-[26px] md:mt-[32px] mb-[42px]" >
                ...
                <div className="flex justify-center">
                    <Image
                        ...
                        height={40}
                        alt="NODIT"
                        className="w-[100px] sm:w-[110px] md:w-[129px] h-auto"
                    />
                </div>
                <div className="flex justify-center">
                    <Image
                        ...
                        height={44}
                        alt="Movebit"
                        className="w-[160px] sm:w-[190px] md:w-[217px] h-auto"
                    />
                </div>
                <div className="flex justify-center">
                    <Image
